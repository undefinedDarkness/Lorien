...
var _canvas: InfiniteCanvas # This is an InfinteCanvas. Can't type it though because of cyclic dependency bugs...
...
func xform_vector2(v: Vector2) -> Vector2:
	return _canvas.get_camera_3d().get_target_position() * (v * _canvas.get_canvas_scale())
